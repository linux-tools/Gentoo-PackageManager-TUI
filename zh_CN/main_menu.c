...
--------------------------------------仓库管理菜单------------------------------------------\n\
-------------------------------------------------------------------------------------------\n\
警告：第二次和第三次操作将非常危险，我建议执行4-8个选项去编辑一些存储库，除非您只是更改镜像以加快获 \n\
取包和更新根据您的位置调整软件包获取速度。切勿删除gentoo源。你被警告了！                         \n\
-------------------------------------------------------------------------------------------\n\
-------------------------------------------------------------------------------------------\n\
******1.更改编辑器（该操作将更改系统editor变量）                                              \n\
******2.编辑src存储库（直接编辑/etc/portage/rerepos.conf/gentoo.conf）                       \n\
******3.编辑二进制存储库（直接编辑/etc/portage/binrepos.conf/gentoobinhost.conf）            \n\
******4.检查可用仓库                                                                        \n\
******5.添加并启用第三方存储库                                                               \n\
******6.禁用存储库（包括官方和第三方存储库）                                                  \n\
******7.禁用存储库（包括官方和第三方存储库）                                                  \n\
******8.添加您自己的存储库（不在在线eselect-repository存储库列表中）                           \n\
******9.同步所有存储库                                                               \n\
******10.返回                                                                             \n\
-------------------------------------------------------------------------------------------\n\
-------------------------------------------------------------------------------------------\n\
